...
description = "Network marketing company operating in the travel industry. Contributed so far to three projects from the ground up."
highlights = [
...
description = "Engaged in the Web Domain contributing to the transformation of the domain's core legacy monolith solution into microservices."
highlights = [
...
company = "Checkmarx"
role = "Software Developer"
period = "03/2017 – 07/2018"
description = "Developments in the main Checkmarx product CxSAST (Static Application Security Testing)."
highlights = [
...
description = "Maintenance and new developments for TIMWE B2C Mobile Marketing solutions."
highlights = [
...
company = "Smartrial"
role = "Software Developer"
period = "09/2014 – 10/2015"
description = "Developments in a clinical trial software built in Java."
highlights = [
...
description = "Consultant at SPMS (Serviços Partilhados do Ministério da Saúde)."
highlights = [
...
description = "Developments in CGD (Caixa Geral de Depósitos) online banking platform."
highlights = [
...
highlights = [
  ...
  "Web booking application using `PHP (CodeIgniter framework)`, `MySQL`, `jQuery`, `jQueryUI` and `Bootstrap`",
]

[[params.experience]]
company = "Vodafone"
role = "Software Developer"
period = "04/2009 – 01/2011"
description = "Implementation of a Customer support solution prototype for mobile phones."
highlights = [
...
[[params.experience]]
company = "ESTG.IPP"
role = "Licentiate degree in Computer Engineering"
